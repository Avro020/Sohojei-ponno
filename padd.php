 ...
 $target_dir = "assets/img/products/";
                                    ...
                                    // if everything is ok, try to upload file
                                        ...
                                        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                                            ...
                                            $sql = "INSERT INTO product (Name,Location, price,entry_date,Contact_no,imagename,descriptiom,sellerid)
                                             VALUES ('$prname','$location','$price','$entry','$contact','$filename','$description','$uid')";
